    ...
    <div className="space-y-8 pb-20 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link
            href="/backend/children"
            className="px-6 py-3.5 bg-indigo-600 text-white rounded-2xl font-black text-sm uppercase tracking-wider flex items-center justify-center gap-2 shadow-xl shadow-indigo-500/30 hover:scale-105 transition-all outline-none"
          >

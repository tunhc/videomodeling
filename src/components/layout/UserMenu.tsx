        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-4 w-64 bg-white/90 backdrop-blur-xl border border-white shadow-2xl rounded-[32px] overflow-hidden z-50 p-2 origin-top-right"
            >
